...
public class SeleniumUtils {
    ...
    public static boolean checkIfCookieExistsByNameAndValue(WebDriver driver, String cookieName, String cookieValue) {
        Set<Cookie> cookies = driver.manage().getCookies();
        for (Cookie c:cookies) {
            if (c.getName().equalsIgnoreCase(cookieName)) {
                return c.getValue().equalsIgnoreCase(cookieValue);
            }
        }
        return false;
    }
